  ...
  return (
    <section className="relative px-5 md:px-10 py-10 md:py-16 bg-white">
      ...
      >
        ...
        <div
          className="relative z-10 grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-10 px-6 md:px-12 py-10 md:py-14 items-center"
          style={{ color: '#fff' }}
        >
          ...
          <div className="md:col-span-7 order-1 md:order-2">
            ...
            <h3
              className="font-bold mb-5 text-[30px] md:text-[40px] lg:text-[44px]"
              style={{ lineHeight: 1.15, letterSpacing: '-0.02em' }}
            >
              دع{' '}
              <span
                style={{
                  background: `linear-gradient(135deg, ${PRISMA.cyan}, ${PRISMA.pink})`,
            ...
            <p
              className="text-[13px] md:text-[14px] leading-[1.9] mb-6 md:mb-7 max-w-[480px]"
