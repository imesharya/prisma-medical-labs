/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: a75cad9dac13b879bf0cdc85db7e21f8)
...
declare namespace Cloudflare {
	interface Env {
		...
		D1: D1Database;
		ASSETS: Fetcher;
		R2_PUBLIC_DOMAIN: "https://assets.prismalaboratory.com";
		NEXT_PUBLIC_SERVER_URL: string;
		PAYLOAD_SECRET: string;
		WORKER_SELF_REFERENCE: Fetcher /* prisma-laboratory */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "R2_PUBLIC_DOMAIN" | "NEXT_PUBLIC_SERVER_URL" | "PAYLOAD_SECRET">> {}
}
